...
exports.loginPost = [
    ...
    body("username")
        ...
        .matches("^[A-Za-z0-9_]+$", "").withMessage("Usernames match /^[A-Za-z0-9_]+$/"),
    body("password")
...
exports.registerPost = [
    ...
    body("username")
        ...
        .matches("^[A-Za-z0-9_]+$", "").withMessage("Usernames should match /^[A-Za-z0-9_]+$/")
        // TODO: https://express-validator.github.io/docs/custom-error-messages.html
        /*.custom(value => {
